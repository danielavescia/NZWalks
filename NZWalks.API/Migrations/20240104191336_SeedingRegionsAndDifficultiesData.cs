    ...
    public partial class SeedingRegionsAndDifficultiesData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2460b5d3-3885-410b-a187-ad6854774b84"), "Medium" },
                    { new Guid("2d200898-74cc-4553-a752-0c9050f512ed"), "Easy" },
                    { new Guid("a8c0e6ad-3a95-4f92-b210-00bb1248fc68"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("2460b5d3-3885-410b-a187-ad6854774b84"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("2d200898-74cc-4553-a752-0c9050f512ed"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a8c0e6ad-3a95-4f92-b210-00bb1248fc68"));
